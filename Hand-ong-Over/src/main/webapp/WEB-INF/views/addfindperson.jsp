...
<div align="left" style="margin-left: 500px; margin-right: 500px">
    <form action="listfindperson.jsp" enctype="multipart/form-data" method="post">
        <br><label for="title" class="form-label">제목</label>
        <br><input type="text" id="title" name="title"/>

        <br><br><label for="images" class="form-label">방 사진</label>
        <br><input type="file" id="images" name="images"/>
