<%@ page import="edu.handong.handongover.board.FindRoomDAO" %>
<%@ page import="edu.handong.handongover.board.FindRoomVO" %>
...
<%
    FindRoomDAO findRoomDAO = new FindRoomDAO();
    List<FindRoomVO> list = findRoomDAO.getFindRoomList();
